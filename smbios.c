...
static void smbios_build_type_1_table(void)
{
    ...
    SMBIOS_TABLE_SET_STR(1, serial_number_str, "System Serial Number"); //李晓流 dds666 modify 
    if (qemu_uuid_set) {
...
static void smbios_build_type_17_table(unsigned instance, uint64_t size)
{
    ...
    t->speed = cpu_to_le16(5600); //李晓流 dds666 modify 3200mhz
                         ...
                         const char *version)
{
    ...
    SMBIOS_SET_DEFAULT(type4.version, "12th Gen Intel(R) Core(TM) i7-12700K"); //李晓流 dds666 modify
                       ...
                       Error **errp)
{
	...
	*/
	...
	smbios_build_type_7_table(6,"corsair L4 Cache",0x183,0x4000,0x6,0x5,0x1); //李晓流 dds666 added 设置4级Unified缓存，16M
